...
class Preprocessor:
    ...
    # The Task associated with this class.(main class of the project).
    tasks = [
        '1. Data Description',
...
#  Preprocessor class(main class).
obj = Preprocessor()
# calling the main function of our Preprocessor class.
